  ...
  const timelineSteps = [
    {
      icon: Clock,
      title: "Step 1",
      description: "Click the button below and download out app",
      color: "primary"
    },
    {
      icon: TrendingUp,
      title: "Step 2",
      description: "Sign up in your desired course",
      color: "secondary"
    },
    {
      icon: Search,
      title: "Step 3",
      description: "Confirm your entry for 'Vidyarthi Banega Lakhpati' & win upto 5 Lakhs cash prizes",
      color: "primary"
    },
    {
      icon: Rocket,
      title: "Step 4",
      description: "That's it! Get unlimited access to all your desired content",
      color: "secondary"
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16 animate-fade-up">
          <h2 className="font-bebas text-4xl md:text-5xl uppercase text-white mb-4">
            How You’ll <span className="text-primary">Study</span> with Us
          </h2>
          <p className="text-muted-foreground text-xl">
            The proven 4-step system that has helped 1000+ students excel
          </p>
        </div>
