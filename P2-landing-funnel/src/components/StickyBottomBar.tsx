      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button className="btn-primary text-xs md:text-sm">
            Make it yours forever at just ₹1837 <span className="line-through opacity-60">₹45,999</span>
          </button>
          
          <a
            href="https://wa.me/918115889102?text=Hi!%20I'm%20interested%2C%20may%20I%20know%20more%20about%20this%3F" 
            target="_blank"
