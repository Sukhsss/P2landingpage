        ...
        <div className="bg-gradient-to-br from-card to-card/50 rounded-3xl p-8 border border-primary/20 relative overflow-hidden animate-fade-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="relative z-10 space-y-6">
            <div className="flex items-center justify-center gap-4">
              <span className="text-6xl md:text-8xl font-bebas text-primary">₹1837</span>
              <div className="text-left">
                <div className="text-3xl md:text-4xl font-bebas text-muted-foreground line-through">₹45,999</div>
                <div className="text-green-400 font-poppins font-bold">96% OFF</div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white">8 Premium Products</span>
              </div>
              <div className="flex items-center gap-2">
...
className="btn-primary text-xl px-12 py-6">
            Don't miss this now ₹1837 <span className="line-through opacity-60 ml-2">₹45,999</span>
          </button>
        </div>
      </div>
    </section>
